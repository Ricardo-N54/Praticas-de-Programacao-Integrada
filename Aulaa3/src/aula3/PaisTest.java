...
class PaisTest {
	...
	public void setUp() throws Exception {
		...
		PaisService maiorPaisS = new PaisService();
		PaisService maisPopulosoS = new PaisService();

		menorPaisS.criar(menorPais);
		maiorPaisS.criar(maiorPais);
		maisPopulosoS.criar(maisPopuloso);

//		System.out.println("objects created in db");
//		System.out.println(menorPais);
//		System.out.println(maiorPais);
//		System.out.println(maisPopuloso);
	}
	...
	void testeExcluir() {
		...
		menorPais2S.excluir(menorPais2);
		maiorPais2S.excluir(maiorPais2);
		maisPopuloso2S.excluir(maisPopuloso2);
